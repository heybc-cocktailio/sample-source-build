...
<head>
    ...
    <style>
        body { font-family: 'Pretendard', sans-serif; margin: 0; overflow: hidden; transition: background 0.5s ease; }
        .cloud-bg {
        ...
        .dark-mode { background: linear-gradient(120deg, #0f172a 0%, #1e293b 100%) !important; }
    </style>
</head>
<body class="cloud-bg min-h-screen flex items-center justify-center p-4">
    ...
    <div id="main-card" class="glass floating w-full max-w-xl p-10 md:p-14 rounded-[3.5rem] text-center transition-all duration-500">
        ...
        <div class="space-y-4 mb-12">
            ...
            <div class="bg-white/40 p-6 rounded-3xl border border-white/60 text-left hover:bg-white/60 transition-all duration-300 group shadow-sm">
                ...
                <code id="display-hostname" class="block text-sm font-mono font-bold text-slate-800 tracking-tight pl-1">
            ...
            <div class="bg-white/40 p-6 rounded-3xl border border-white/60 text-left hover:bg-white/60 transition-all duration-300 group shadow-sm">
                ...
                <code id="display-ip" class="block text-sm font-mono font-bold text-slate-800 tracking-tight pl-1">
                    <%
    ...
    <script>
        function changeTheme(theme, label) {
            ...
            const hostname = document.getElementById('display-hostname');
            const ip = document.getElementById('display-ip');
            ...
            if (theme === 'black') {
                ...
                hostname.style.color = '#cbd5e1';
                ip.style.color = '#cbd5e1';
            } else {
                body.classList.remove('dark-mode');
                card.style.background = 'rgba(255, 255, 255, 0.75)';
                card.style.borderColor = 'rgba(255, 255, 255, 0.4)';
                h1.style.color = '#1e293b';
                hostname.style.color = '#1e293b';
                ip.style.color = '#1e293b';
            }
        }
